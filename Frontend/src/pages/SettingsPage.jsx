                ...
                <div className="w-full max-w-md space-y-6 p-6 sm:p-8 
                   sm:bg-[rgb(var(--card-bg))] sm:border sm:border-[rgb(var(--card-border))] sm:shadow-xl sm:rounded-2xl">
                    ...
                    <div className="flex justify-between items-center p-4 bg-[rgb(var(--setting-bg))] border border-[rgb(var(--input-border))] rounded-lg">
                        ...
                        <button
                            onClick={toggleTheme}
                            className={`relative w-14 h-8 flex items-center rounded-full transition-colors duration-300 ${theme === "dark" ? "bg-blue-500" : "bg-gray-400"
                                }`}
                        >
                            <span
                                className={`absolute w-6 h-6 flex items-center justify-center bg-white rounded-full shadow-md transform transition-transform duration-300 ${theme === "dark" ? "translate-x-7" : "translate-x-1"
                                    }`}
                            >
                                {theme === "dark" ? "🌙" : "☀️"}
                            </span>
